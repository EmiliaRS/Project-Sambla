...
function computeResults(e) {
  ...
  document.getElementById("monthlyPayment").innerHTML = monthlyPayment + " kr";

  document.getElementById("totalInterest").innerHTML = totalInterest + " kr";

  document.getElementById("totalPayment").innerHTML = totalPayment + " kr";
